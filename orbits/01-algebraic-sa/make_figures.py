...
def make_results():
    """Quantitative panel: metric comparison + greedy-size distribution."""
    ...
    strategies = [
        ...
        ("Random greedy\n(5000 restarts)", 19, COLORS["greedy"], ""),
    ...
    ax2.axvline(19, color=COLORS["target"], linestyle=":", linewidth=1.5,
                zorder=3, label="greedy best (2 of 5000)")
    ...
    ax2.set_ylim(0, 2300)
    ax2.set_title("Greedy outcome distribution — 20 never reached without SA",
                  pad=28)
